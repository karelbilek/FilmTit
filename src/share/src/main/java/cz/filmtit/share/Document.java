...
public class Document implements IsSerializable, Serializable, Comparable<Document> {
    ...
    /**
     * Sets the database ID if it has not been set before. Throws an excpetion otherwise.
    ...
    /**
     * Sets ID of the user owning the document if it has not been set before, throws an exception
     * otherwise.
     ...
     * @param translatedChunksCount Number of document chunks that has been already translated.
     */
    ...
    /**
     * Gets the translation results the document consist of as list sorted by the chunks timing.
    ...
    /**
     * Gets the translation results of the document as map of chunk
     * indexes and translation results.
    ...
    /**
     * Compares the document with a different one to order them
     * by the time of the last change in the descending order.
