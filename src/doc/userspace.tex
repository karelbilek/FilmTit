...
Users can export the files in .srt format. We decided to ignore .sub format because, as is shown in \ref{sec:properties}, in the initial data, the .sub percentage was minimal and the work needed would be too big.\todo{Make sure we delete the option from GUI and from source}
