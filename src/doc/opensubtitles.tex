...
As you can see even just by looking at the numbers, it is obvious that the data in the database and the files don't match up exactly. So the initial clean-up was getting only the intersection of files we have and the files that are in the database. The intersection is 39,712 Czech subtitle files and 97,991 English files of 15,881 mediasources -- 3,032 MB of zipped data.
