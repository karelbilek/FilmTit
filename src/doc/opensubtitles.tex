...
Since we wanted the translation memory to be functional from the very beginning, we needed to build a parallel corpus -- best from some repository of subtitles. 

Right after we recieved the data from \emph{opensubtitles.org} and had the "raw" subtitle data, we started to build a parallel corpus from that data to use for translation memory. The process of creating the corpus a and getting the "clean" translation memory data is described in the following sections.
