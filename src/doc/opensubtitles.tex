...
\begin{itemize}
    \item file, called \texttt{export.gz}, which was a tab-separated table, having information about one subtitle file on one line. The information consisted from:
    \begin{itemize}
        \item ID of a media source (seemed like an internal OS.org ID)
        \item name of the subtitle file (a number)
        \item language of the subtitle
