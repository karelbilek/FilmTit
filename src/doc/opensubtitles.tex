...
With some consideration, we count precision as \footnote{Strictly speaking, it is not precision or recall at all. However, intuitively it captures similar qualities and it may be more confusing to use a different terminology.}
