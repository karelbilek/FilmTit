...
Also, we wanted to avoid any copyright problems we would meet by using random subtitles from the Internet. For this purpose, we directly asked the administrator of the biggest server providing the subtitle site \emph{opensubtitles.org} for the data.

As a reply, we received all subtitle files in Czech and English from \emph{opensubtitles.org} with following license condition (in Slovak):
