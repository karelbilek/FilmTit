...
Your data are available from any computer at any time exactly in the state you left them. (Except for the Offline Mode, where your data is saved to the server only when you go online again.)
...
Firefox v.~14, Chrome v.~21, Safari v.~5.1.5, or higher). To use the optional video playback in your browser, you also need to have Java (at least version 1.6) and the VLC plugin (at least version 1.1.4).\todo{add it, who knows it -- I just added my versions, for which it works... RR}
