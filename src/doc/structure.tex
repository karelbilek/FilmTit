...
\item {\bf Posgre SQL 9.1.} -- PosgreSQL (similar to MIT and BSD lincences)
...
\item {\bf Apache XML-RPC client} 
\item {\bf Apache Commons} -- Apache License 2.0 \\
lang3, math, validator  
...
\item {\bf log4j 1.2.16}  -- Apache License 2.0 \\
