...
- classes must have getters and setters (but they can be private)

- classes must have parameter-less constructor (but can be private)

- limitting number of connections

- having to add members not only to class but also to mapping

- necessary to drop the tables on any change
