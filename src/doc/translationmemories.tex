...
By the way, in the examples in table \ref{subtitleFormats}, you can notice the mixup of letter ``l'' and ``I''. That is indeed not an error on our part, but error, caused by copying DVD subtitle to text file using programs like SubRip, that use some easy form of OCR to get the text information; and ``I'' and ``l'' often look indistinguishable in sans-serif fonts used often in the DVD subtitles.
