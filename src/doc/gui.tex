...
We intentionally didn't implement very sophisticated controls for the player (since it would make the design too complicated). All the player can do is replay the whole current window or pause the playing\todo{I will maybe implement the unpausing if I got time. If I don't have time, I won't.}.
