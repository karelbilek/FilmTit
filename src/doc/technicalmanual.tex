...
Size of the jar file? Running server needs cca 500 MB of memory. How big is the database??? The more memory, the better, we run it with ??? memory on the server. \todo{write it :-)}
