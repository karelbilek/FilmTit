...
\chapter{System Requirements and Setup}
...
\section{Step-by-Step Guide: Setting up the server with an existing database dump}
...
\subsection{Setting up the indexes}
...
\section{Text processing models}
...
\section{Module-Specific Options}
...
\chapter{Adapting the TM to new language pairs}
...
\section{Basic Setup: Exact and Fuzzy Matching}
...
\section{Advanced Setup: Program-based Signatures and Machine Translation}
